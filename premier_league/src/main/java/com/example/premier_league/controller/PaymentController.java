...
public class PaymentController {
    ...
    public String savePayment(HttpServletRequest req) throws UnsupportedEncodingException {
...
//        String vnp_TxnRef = "1238";
    ...
    @GetMapping("/showFormToPay")
    public String showFormToPay(Model model, @RequestParam(name = "total", required = false) Integer total) {
        if (total == null || total <= 0) {
            // Có thể cho quay lại trang chọn vé, hoặc hiển thị thông báo lỗi mềm
            // tùy bạn muốn UX thế nào
            return "redirect:/";
        }
